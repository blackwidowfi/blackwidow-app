    ...
    <footer className="border-border bg-background text-muted-foreground border-t py-8">
      <div className="container flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-105 text-sm leading-5">{t("footer.disclaimer")}</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <div className="flex items-center gap-6 text-sm">
            ...
            >
              <span className="sr-only">{t("footer.follow_on_x")}</span>
            ...
            <a
              ...
              className="text-muted-foreground hover:text-foreground rounded-lg p-1.5 transition"
            >
              <span className="sr-only">{t("footer.github_label")}</span>
              <svg viewBox="0 0 16 16" aria-hidden="true" width="18" height="18">
                <path
                  fill="currentColor"
