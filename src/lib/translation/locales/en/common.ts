export default {
  ...
  demo: {
    ...
    withdraw_available_label: "Withdrawable",
    max_button: "Max",
    deposit_amount_label: "Amount",
    deposit_helper:
      "Deposit mints Blackwidow shares. Withdraw burns shares and unwraps SOL back to your wallet.",
    deposit_button: "Deposit",
    deposit_status_pending: "Depositing...",
    deposit_status_confirmed: "Deposit confirmed",
    withdraw_button: "Withdraw",
    withdraw_status_pending: "Withdrawing...",
    withdraw_status_confirmed: "Withdraw confirmed",
    withdraw_limit_message: "Withdraw max: {{amount}}",
